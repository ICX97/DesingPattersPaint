...
public class DrawingHandler implements FileHandler{
	...
	public DrawingHandler(DrawingModel model, DrawingController controller, DrawingFrame frame) {
		this.model = model;
	...
	public void read(String line) {
		try {
			...
			case "Add":
				...
				if (command[1].equalsIgnoreCase("Donut")) {
					...
					AddDonutCmd cmdCC = new AddDonutCmd(this.model, cwc);
					cmdCC.execute();
			...
			case "Delete":
				...
				if (command[1].equalsIgnoreCase("Point")) {
				...
				} else if (command[1].equalsIgnoreCase("Donut")) {
					...
					Donut s = new Donut(
							...
							new Color(Integer.parseInt(command[6])), new Color(Integer.parseInt(command[7])));
					index = model.getAll().indexOf(s);
					DeleteDonutCmd cmd = new DeleteDonutCmd(model, (Donut) model.getShape(index));
					cmd.execute();
					controller.getUndoStack().push(cmd);
					frame.getLogFrame().getModel().addElement("Delete," + s.toString());
			...
			case "Modify":
				...
				if (command[1].equalsIgnoreCase("Point")) {
					...
					UpdateDonutCmd cmd = new UpdateDonutCmd((Donut) model.getShape(indexx), pp);
					cmd.execute();
					controller.getUndoStack().push(cmd);
					frame.getLogFrame().getModel().addElement("Modify," + ss.toString() + pp.toString());
			...
			case "MoveUp":
				...
				if (command[1].equalsIgnoreCase("Point")) {
					...
					ss = new Donut(new Point(Integer.parseInt(command[2]), Integer.parseInt(command[3])),
							Integer.parseInt(command[4]), Integer.parseInt(command[5]),
							new Color(Integer.parseInt(command[6])), new Color(Integer.parseInt(command[7])));
					index1 = model.getAll().indexOf(ss);
					MoveUpCmd cmdMU = new MoveUpCmd(model.getAll(), model.getShape(index1));
			...
			case "MoveDown":
				...
				if (command[1].equalsIgnoreCase("Point")) {
					...
					sh = new Donut(new Point(Integer.parseInt(command[2]), Integer.parseInt(command[3])),
							Integer.parseInt(command[4]), Integer.parseInt(command[5]),
							new Color(Integer.parseInt(command[6])), new Color(Integer.parseInt(command[7])));
					index2 = model.getAll().indexOf(sh);
					MoveDownCmd cmdMD = new MoveDownCmd(model.getAll(), model.getShape(index2));
			...
			case "MoveBottom":
				...
				if (command[1].equalsIgnoreCase("Point")) {
					...
					shape = new Donut(new Point(Integer.parseInt(command[2]), Integer.parseInt(command[3])),
							Integer.parseInt(command[4]), Integer.parseInt(command[5]),
							new Color(Integer.parseInt(command[6])), new Color(Integer.parseInt(command[7])));
					index3 = model.getAll().indexOf(shape);
					MoveToBottomCmd cmdMD = new MoveToBottomCmd(model.getAll(), model.getShape(index3));
			...
			case "Select":
				...
				if (command[1].equalsIgnoreCase("Point")) {
					...
					shapeSel = new Donut(new Point(Integer.parseInt(command[2]), Integer.parseInt(command[3])),
							Integer.parseInt(command[4]), Integer.parseInt(command[5]),
							new Color(Integer.parseInt(command[6])), new Color(Integer.parseInt(command[7])));
			...
			case "MoveTop":
				...
				if (command[1].equalsIgnoreCase("Point")) {
					...
					shape4 = new Donut(new Point(Integer.parseInt(command[2]), Integer.parseInt(command[3])),
							Integer.parseInt(command[4]), Integer.parseInt(command[5]),
							new Color(Integer.parseInt(command[6])), new Color(Integer.parseInt(command[7])));
					index4 = model.getAll().indexOf(shape4);
					MoveToTopCmd cmdMD = new MoveToTopCmd(model.getAll(), model.getShape(index4));

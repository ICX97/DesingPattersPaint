...
public class Donut extends Circle implements Serializable {
	...
	public Donut(Point center, int r, int holeRadius) {
		super(center, r);
		this.holeRadius = holeRadius;
	}
	
	public Donut(Point center, int r, int holeRadius, Color color) {
		this(center, r, holeRadius);
		setColor(color);
	}
	
	public Donut(Point center, int r, int holeRadius, Color color, Color innerColor) {
	...
	public String toString() {
		return "Donut," + this.center.getX() + "," + this.center.getY() + "," + this.r + "," + this.holeRadius
	...
	public Donut clone() {
		return new Donut(getCenter().clone(), getR(), getHoleRadius(), getColor(), getInnerColor());
	}
